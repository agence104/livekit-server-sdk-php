...
/**
 * A JSON client that implements the {@see AgentDispatchService} interface.
 ...
 */
final class AgentDispatchServiceJsonClient extends AgentDispatchServiceAbstractClient implements AgentDispatchService
{
    /**
     * @inheritDoc
     */
