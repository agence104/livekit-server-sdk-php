...
/**
 * A Protobuf client that implements the {@see AgentDispatchService} interface.
 ...
 */
final class AgentDispatchServiceClient extends AgentDispatchServiceAbstractClient implements AgentDispatchService
{
    /**
     * @inheritDoc
     */
