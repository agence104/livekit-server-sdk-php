...
/**
 * A Protobuf client that implements the {@see AgentSimulation} interface.
 ...
 */
final class AgentSimulationClient extends AgentSimulationAbstractClient implements AgentSimulation
{
    /**
     * @inheritDoc
     */
