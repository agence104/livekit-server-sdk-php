...
/**
 * A Protobuf client that implements the {@see PhoneNumberService} interface.
 ...
 */
final class PhoneNumberServiceClient extends PhoneNumberServiceAbstractClient implements PhoneNumberService
{
    /**
     * @inheritDoc
     */
