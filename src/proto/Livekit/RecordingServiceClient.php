...
/**
 * A Protobuf client that implements the {@see RecordingService} interface.
 ...
 */
final class RecordingServiceClient extends RecordingServiceAbstractClient implements RecordingService
{
    /**
     * @inheritDoc
     */
