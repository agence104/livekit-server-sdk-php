...
/**
 * @internal PhoneNumberServiceAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class PhoneNumberServiceAbstractClient
{
    /**
     * @var string
     */
     ...
     * {@inheritdoc}
     */
    public function SearchPhoneNumbers(array $ctx, \Livekit\SearchPhoneNumbersRequest $in): \Livekit\SearchPhoneNumbersResponse
    {
        ...
        $out = new \Livekit\SearchPhoneNumbersResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/SearchPhoneNumbers';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/SearchPhoneNumbers';
        }
     ...
     * {@inheritdoc}
     */
    public function PurchasePhoneNumber(array $ctx, \Livekit\PurchasePhoneNumberRequest $in): \Livekit\PurchasePhoneNumberResponse
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'PhoneNumberService');
        $ctx = Context::withMethodName($ctx, 'PurchasePhoneNumber');

        $out = new \Livekit\PurchasePhoneNumberResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/PurchasePhoneNumber';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/PurchasePhoneNumber';
        }
     ...
     * {@inheritdoc}
     */
    public function ListPhoneNumbers(array $ctx, \Livekit\ListPhoneNumbersRequest $in): \Livekit\ListPhoneNumbersResponse
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'PhoneNumberService');
        $ctx = Context::withMethodName($ctx, 'ListPhoneNumbers');

        $out = new \Livekit\ListPhoneNumbersResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/ListPhoneNumbers';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/ListPhoneNumbers';
        }
     ...
     * {@inheritdoc}
     */
    public function GetPhoneNumber(array $ctx, \Livekit\GetPhoneNumberRequest $in): \Livekit\GetPhoneNumberResponse
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'PhoneNumberService');
        $ctx = Context::withMethodName($ctx, 'GetPhoneNumber');

        $out = new \Livekit\GetPhoneNumberResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/GetPhoneNumber';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/GetPhoneNumber';
        }
     ...
     * {@inheritdoc}
     */
    public function UpdatePhoneNumber(array $ctx, \Livekit\UpdatePhoneNumberRequest $in): \Livekit\UpdatePhoneNumberResponse
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'PhoneNumberService');
        $ctx = Context::withMethodName($ctx, 'UpdatePhoneNumber');

        $out = new \Livekit\UpdatePhoneNumberResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/UpdatePhoneNumber';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/UpdatePhoneNumber';
        }
     ...
     * {@inheritdoc}
     */
    public function ReleasePhoneNumbers(array $ctx, \Livekit\ReleasePhoneNumbersRequest $in): \Livekit\ReleasePhoneNumbersResponse
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'PhoneNumberService');
        $ctx = Context::withMethodName($ctx, 'ReleasePhoneNumbers');

        $out = new \Livekit\ReleasePhoneNumbersResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.PhoneNumberService/ReleasePhoneNumbers';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.PhoneNumberService/ReleasePhoneNumbers';
        }
