...
/**
 * A JSON client that implements the {@see PhoneNumberService} interface.
 ...
 */
final class PhoneNumberServiceJsonClient extends PhoneNumberServiceAbstractClient implements PhoneNumberService
{
    /**
     * @inheritDoc
     */
