...
/**
 * A JSON client that implements the {@see RecordingService} interface.
 ...
 */
final class RecordingServiceJsonClient extends RecordingServiceAbstractClient implements RecordingService
{
    /**
     * @inheritDoc
     */
