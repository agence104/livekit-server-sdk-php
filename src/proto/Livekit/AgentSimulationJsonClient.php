...
/**
 * A JSON client that implements the {@see AgentSimulation} interface.
 ...
 */
final class AgentSimulationJsonClient extends AgentSimulationAbstractClient implements AgentSimulation
{
    /**
     * @inheritDoc
     */
