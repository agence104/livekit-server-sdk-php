...
/**
 * @internal RecordingServiceAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class RecordingServiceAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function StartRecording(array $ctx, \Livekit\StartRecordingRequest $in): \Livekit\StartRecordingResponse
    {
        ...
        $out = new \Livekit\StartRecordingResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.RecordingService/StartRecording';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.RecordingService/StartRecording';
        }
     ...
     * {@inheritdoc}
     */
    public function AddOutput(array $ctx, \Livekit\AddOutputRequest $in): \Google\Protobuf\GPBEmpty
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'RecordingService');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.RecordingService/AddOutput';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.RecordingService/AddOutput';
        }
     ...
     * {@inheritdoc}
     */
    public function RemoveOutput(array $ctx, \Livekit\RemoveOutputRequest $in): \Google\Protobuf\GPBEmpty
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'RecordingService');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.RecordingService/RemoveOutput';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.RecordingService/RemoveOutput';
        }
     ...
     * {@inheritdoc}
     */
    public function EndRecording(array $ctx, \Livekit\EndRecordingRequest $in): \Google\Protobuf\GPBEmpty
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'RecordingService');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.RecordingService/EndRecording';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.RecordingService/EndRecording';
        }
