...
/**
 * @internal AgentDispatchServiceAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class AgentDispatchServiceAbstractClient
{
    /**
     * @var string
     */
     ...
     * {@inheritdoc}
     */
    public function CreateDispatch(array $ctx, \Livekit\CreateAgentDispatchRequest $in): \Livekit\AgentDispatch
    {
        ...
        $out = new \Livekit\AgentDispatch();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.AgentDispatchService/CreateDispatch';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.AgentDispatchService/CreateDispatch';
        }
     ...
     * {@inheritdoc}
     */
    public function DeleteDispatch(array $ctx, \Livekit\DeleteAgentDispatchRequest $in): \Livekit\AgentDispatch
    {
        $ctx = Context::withPackageName($ctx, 'livekit');
        $ctx = Context::withServiceName($ctx, 'AgentDispatchService');
        ...
        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.AgentDispatchService/DeleteDispatch';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.AgentDispatchService/DeleteDispatch';
        }
    ...
    public function ListDispatch(array $ctx, \Livekit\ListAgentDispatchRequest $in): \Livekit\ListAgentDispatchResponse
    {
        ...
        $out = new \Livekit\ListAgentDispatchResponse();

        $url = $this->addr;
        if (empty($this->prefix)) {
            $url = $url.'/livekit.AgentDispatchService/ListDispatch';
        } else {
            $url = $url.'/'.$this->prefix.'/livekit.AgentDispatchService/ListDispatch';
        }
